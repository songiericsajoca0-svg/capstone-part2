  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center h-20"> 
      ...
      <div class="flex items-center logo-container">
        <a href="<?php 
            if (isset($_SESSION['user_id'])) {
                ...
                elseif ($_SESSION['role'] === 'driver') echo '../driver/dashboard.php';
      ...
      <nav class="hidden md:flex items-center">
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
          ...
          <a href="<?php 
             ...
             ?>" class="nav-link <?php echo isActive('dashboard.php'); ?>">Dashboard</a>

          <?php if ($_SESSION['role'] === 'admin'): ?>
            <a href="../admin/location.php" class="nav-link <?php echo isActive('location.php'); ?>">Available Locations</a>
            <a href="../admin/active-trips.php" class="nav-link <?php echo isActive('active-trips.php'); ?>">Active Trips</a>
            ...
            <a href="../admin/passenger_accounts.php" class="nav-link <?php echo isActive('passenger_accounts.php'); ?>">Passengers</a>
            <a href="../admin/history.php" class="nav-link <?php echo isActive('history.php'); ?>">Bookings</a>
          <?php endif; ?>

          <?php if ($_SESSION['role'] === 'driver'): ?>
            <a href="../driver/scanner.php" class="nav-link <?php echo isActive('scanner.php'); ?>">Scanner</a>
          ...
          <?php if ($_SESSION['role'] === 'passenger'): ?>
            ...
            <a href="../passenger/history.php" class="nav-link <?php echo isActive('history.php'); ?>">History</a>
      ...
      <div class="md:hidden flex items-center">
        <button type="button" class="p-2 text-gray-700 hover:text-blue-700 focus:outline-none">
